...
prediction.setModelTypeAsDenseNet()  # sets the model type of prediction as ResNet - one we used
...
prediction, probabilities = prediction.predictImage("image.jpg", result_count=3)
